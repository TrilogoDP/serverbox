<?php
class ControllerExtensionModuleLuxshopBannerPro extends Controller {
	public function index($setting) {

		static $module = 0;
		$this->document->addStyle('catalog/view/theme/luxshop/stylesheet/banner_pro.css');
		...
		return $this->load->view('extension/module/luxshop_banner_pro', $data);
	}
}