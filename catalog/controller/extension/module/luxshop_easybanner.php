<?php
class ControllerExtensionModuleLuxshopEasybanner extends Controller {
	public function index($setting) {

		static $module = 0;
		$this->document->addStyle('catalog/view/theme/luxshop/stylesheet/easybanner.css');
		...
		return $this->load->view('extension/module/luxshop_easybanner', $data);
	}
}