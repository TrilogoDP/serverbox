<?php
class ControllerExtensionModuleLuxshopLatestGrid extends Controller {
	...
	public function index($setting) {
		...
		$this->load->language('extension/module/luxshop_latest_grid');
		...
		$results = $this->model_luxshop_theme->getLatest($filter_data);
		...
		if ($results) {
			...
			return $this->load->view('extension/module/luxshop_latest_grid', $data);
		}
	}
}
