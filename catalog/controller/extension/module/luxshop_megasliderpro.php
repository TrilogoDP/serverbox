<?php
class ControllerExtensionModuleLuxshopMegasliderpro extends Controller {
	public function index($setting) {

		static $module = 0;
		$this->load->model('megasliderpro/megaslider');
		$this->load->model('tool/image');
		$this->document->addStyle('catalog/view/theme/luxshop/js/megasliderpro/style.css');
		//$this->document->addScript('catalog/view/theme/luxshop/js/megasliderpro/jquery.nivo.slider.js');
		...
		if($results) {
			...
			$data['html_css'] = $css;
			$data['module'] = $module++;
			return $this->load->view('extension/module/luxshop_megasliderpro', $data);
