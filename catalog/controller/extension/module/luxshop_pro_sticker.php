<?php
class ControllerExtensionModuleLuxshopProSticker extends Controller {
	public function index() {
		...
		$this->document->addStyle('catalog/view/theme/luxshop/stylesheet/prosticker.css');
		return $this->load->view('extension/module/luxshop_pro_sticker', $data);
	...
	public function load_content() {
		...
		$data['preg1'] = '/\/[a-zA-Zа-яА-ЯёЁ0-9\-\_\%]*[\.]{0,1}[a-zA-Z]{0,}\?|$/';
		$data['preg2'] = '/\/([a-zA-Zа-яА-ЯёЁ0-9\-\_\%]*)[^]{0,1}[a-zA-Z]{0,}(?:\?|$)/';
		$data['url_module'] = 'index.php?route=extension/module/luxshop_pro_sticker/ProStickerLoad';
		$this->response->setOutput($this->load->view('extension/module/luxshop_pro_sticker_load', $data));
	...
	public function ProStickerLoad() {
		...
		if ($products_id) {
			...
			if ($results) {
				$positions = array(
					'topleft' => 'top 0px left',
					'topcenter' => 'top 0px center',
					'topright' => 'top 0px right',
					'centerleft' => 'center left',
					'centercenter' => 'center center',
					'centerright' => 'center right',
					'bottomleft' => 'bottom 15px left',
					'bottomcenter' => 'bottom 15px center',
					'bottomright' => 'bottom 15px right'
				);
	...
	private function getSettings() {
		$settings = $this->config->get('module_luxshop_pro_sticker_settings');
		$default = array (
			'class' => '.image',
