<?php
class ControllerExtensionModuleLuxshopReviewsStore extends Controller {
  ...
  public function index($setting) {
    ...
    $reviews_store_total = $this->model_catalog_luxshop_reviews_store->getTotalReviewsStore();
    ...
    $data['all_review_link'] = $this->url->link('product/luxshop_reviews_store');
    ...
    return $this->load->view('extension/module/luxshop_reviews_store', $data);
  }
  }
}