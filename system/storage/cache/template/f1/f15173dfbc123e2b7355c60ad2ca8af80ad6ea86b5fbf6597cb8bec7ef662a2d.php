...
/* luxshop/template/extension/module/latest.twig */
class __TwigTemplate_65d43d3e4bdf7ec982afe27b3dd65d8acad92ca66548ebb9adb51b1cf61f0c1d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $context["gen_carousel_latest"] = twig_random($this->env, 1, 99);
        // line 2
...
<div class=\"container-modules latest carousel_numb_latest";
        // line 5
        echo ($context["gen_carousel_latest"] ?? null);
        echo "\">
  ";
        // line 6
...
<script>
var items_mob = 2;
if (\$(\".carousel_numb_latest";
        // line 238
        echo ($context["gen_carousel_latest"] ?? null);
        echo "\").parents(\".position-no-owl\").length == 1) {
\tvar items_mob = 1;
\$('.carousel_numb_latest";
        // line 240
        echo ($context["gen_carousel_latest"] ?? null);
        echo "').each(function() {
...
slickSliderModule(\".carousel_numb_latest";
        // line 247
        echo ($context["gen_carousel_latest"] ?? null);
        echo "\",items_mob);
</script>
    ...
    {
        return "luxshop/template/extension/module/latest.twig";
    }
    ...
    {
        return new Source("", "luxshop/template/extension/module/latest.twig", "");
    }
}
