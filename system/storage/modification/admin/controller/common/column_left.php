...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		$luxshop_left_menu = array();
		$luxshop_left_menu[] = array(
			'name'	   => $this->language->get('text_luxshop_theme'),
			'href'     => $this->url->link('extension/module/luxshop_setting_theme', 'user_token=' . $this->session->data['user_token'], true),
			'children' => array()
		);
		if ($this->user->hasPermission('access', 'luxshop/luxshop_demo')) {
			$luxshop_left_menu[] = array(
				'name'	   => $this->language->get('text_add_demo'),
				'href'     => $this->url->link('luxshop/luxshop_demo', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
		}
		...
		if ($this->user->hasPermission('access', 'sale/callback')) {
			...
			$luxshop_news = array();
			if ($this->user->hasPermission('access', 'luxshop/news_settings')) {
				$luxshop_news[] = array(
					'name'	   => $this->language->get('text_news_settings'),
					'href'     => $this->url->link('luxshop/news_settings', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			
			if($this->config->get('luxshop_news_status')){
				if ($this->user->hasPermission('access', 'luxshop/news')) {
					$luxshop_news[] = array(
						'name'     => $this->language->get('text_news_category'),
						'href'     => $this->url->link('luxshop/news', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()	
					);
				}
				
				if ($this->user->hasPermission('access', 'luxshop/news_articles')) {
					$luxshop_news[] = array(
						'name'	   => $this->language->get('text_news_articles'),
						'href'     => $this->url->link('luxshop/news_articles', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
				}
				
				if ($this->user->hasPermission('access', 'luxshop/news_review')) {
					$luxshop_news[] = array(
						'name'	   => $this->language->get('text_news_review'),
						'href'     => $this->url->link('luxshop/news_review', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
				}
			}
		...
		if ($this->user->hasPermission('access', 'sale/newfastorder')) {
			...
			if (isset($question_answer['status']) && $question_answer['status']) {
				$luxshop_left_menu[] = array(
					...
					'href'     => $this->url->link('extension/module/luxshop_question_answer', 'tablist=1&user_token=' . $this->session->data['user_token'], 'SSL'),
					'children' => array()		
				);
			}
			...
			$luxshop_left_menu[] = array(
				...
				'href'     => $this->url->link('extension/module/luxshop_found_cheaper_product', 'tablist=1&user_token=' . $this->session->data['user_token'], 'SSL'),
				'children' => array()		
			);
			}
		...
		$data['menus'][] = array(
				'id'       => 'menu-luxshop',
				'icon'	   => 'view/image/luxshop_icon.svg',
				'name'	   => $this->language->get('text_luxshop_menu'),
				'href'     => '',
				'children' => $luxshop_left_menu
		);  
