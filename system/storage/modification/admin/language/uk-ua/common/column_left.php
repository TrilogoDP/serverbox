...
// Text
			...
			$_['text_news'] = 'Новини';
			$_['text_news_category'] = 'Категорії';
			$_['text_news_articles'] = 'Статті';
			$_['text_news_settings'] = 'Налаштування';
			$_['text_news_review'] = 'Відгуки';
...
$_['text_captcha']                     = 'Капча';
		...
		$_['text_add_demo'] = 'Швидкий старт';
        $_['text_luxshop_menu'] = 'LuxShop';
        $_['text_luxshop_theme'] = 'Налаштування шаблона';
      

        $_['text_newsletter'] = 'Список Підписників';
      

        $_['text_product_tabs'] = 'Дод. вкладки';
      

        $_['text_reviews_store'] = 'Відгуки про магазин';
        $_['text_reviews_store_list'] = 'Список відгуків';
        $_['text_reviews_store_setting'] = 'Налаштування';
