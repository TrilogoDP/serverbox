...
// Text
				...
				$_['text_column_comment_manager']           = 'Коментар менеджера';
				$_['text_column_price_purchase']           	= 'Ціна Закупки';
				$_['text_column_total_profit']           	= 'Прибуток';
				$_['text_column_manager_process_orders']    = 'Менеджер';
				$_['text_column_rise_product']    			= 'Подйом';
				$_['text_column_build_price']    			= 'Збирання';
				$_['text_column_delivery_price']    		= 'Вартість Доставки';
				$_['text_column_send_ttn_email']    		= 'Відправка ТТН на пошту клієнту';
				$_['text_btn_send_ttn']    					= 'Надіслати';
				$_['text_product_model']    				= 'Модель';
				$_['text_product_sku']    					= 'SKU';
				$_['text_product_upc']    					= 'UPC';
				$_['entry_build_yes_no']    				= 'Збирання';
				$_['entry_rise_yes_no']    					= 'Підйом';
				$_['entry_delivery_price']    				= 'Вартість Доставки';
				$_['entry_calculated_summ']    				= 'Прибуток';
				$_['entry_manager_process_orders']    		= 'Менеджер';
				$_['text_yes']    							= 'Так';
				$_['text_no']    							= 'Ні';
				$_['entry_date_added_start']    			= 'Дата додання - з';
				$_['entry_date_added_end']    				= 'Дату додання - по';
