...
class ControllerProductSpecial extends Controller {
	public function index() {
		$this->load->language('product/special');
			...
			$data['config_price_list_view_on_off'] = $this->config->get('config_price_list_view_on_off_special_page');
		...
		foreach ($results as $result) {
			...
			if(isset($data['ns_on_off_special_page_slider_additional_image']) && ($data['ns_on_off_special_page_slider_additional_image'] == 1)){
