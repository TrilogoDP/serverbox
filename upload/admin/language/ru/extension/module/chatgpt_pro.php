...
<ol>
	<li>Перейдите в телеграм-чат&nbsp;<a href="[link_chat]" target="_blank">[link_name]</a>.</li>
	<li>В теме «<a href="[link_keys]" target="_blank">Ключ&nbsp;лицензии</a>» укажите номер заказа и адрес ресурса, где вы приобрели модуль.</li>
	<li>Получите лицензионный ключ и активируйте модуль на вкладке <b>Настройки</b>.</li>
	...
	<li>Сохраните&nbsp;API ключ в настройках и начинайте использовать этот потрясающий модуль!</li>
	<li>Купите чашечку кофе хорошему парню&nbsp;:] <a href="[link_donate]" target="_blank"><b>Задонатить!</b></a></li>
</ol>
END;
...
<div class="visible-lg col-lg-2 hypnoblock">
	...
	<div class="">
	<a class="donut_btn btn btn-block btn-default btn-sm" href="[link_donate]" target="_blank" title="Cheers! ^_^">Задонать! <img src="view/image/chatgpt_pro/pink_donut.png" class="img-responsive"></a>
	<br>
	</div>
	Поддержка:<br><a href="[link_chat]" target="_blank">@[link_name]</a><br><br>
	Обновления:<br><a href="[link_channel]" target="_blank">@OpenCartGPT</a><br>
</div>
END;
