...
<ol>
<li>Перейдіть до телеграм-чату <a href="[link_chat]" target="_blank">[link_name]</a>.</li>
<li>У темі «<a href="[link_keys]" target="_blank">Ключ ліцензії</a>» вкажіть номер замовлення та адресу ресурсу, де ви придбали модуль.</li>
<li>Отримайте ліцензійний ключ та активуйте модуль на вкладці <b>Налаштування</b>.</li>
...
<li>Збережіть API ключ в налаштуваннях та починайте використовувати цей чудовий модуль!</li>
<li>Купіть чашку кави хорошому хлопцю :] <a href="[link_donate]" target="_blank"><b>Задонатити!</b></a></li>
</ol>
END;
...
<div class="">
<a class="donut_btn btn btn-block btn-default btn-sm" href="[link_donate]" target="_blank" title="Cheers! ^_^">Задонатити! <img src="view/image/chatgpt_pro/pink_donut.png" class="img-responsive"></a>
<br>
</div>
Підтримка:<br><a href="[link_chat]" target="_blank">@[link_name]</a><br><br>
Оновлення:<br><a href="[link_channel]" target="_blank">@OpenCartGPT</a><br>
</div>
END;
