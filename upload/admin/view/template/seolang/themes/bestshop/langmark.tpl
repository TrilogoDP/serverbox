...
<div id="form-language">
  <div class="btn-group">
    ...
    <?php } ?>
    <?php } ?>
    <span class="  <?php if (isset($settings_widget['image_status']) && $settings_widget['image_status']) { ?>hidden-xs hidden-sm hidden-md<?php } ?>"><?php echo $text_language; ?></span> <i class="fa fa-angle-down"></i></button>
