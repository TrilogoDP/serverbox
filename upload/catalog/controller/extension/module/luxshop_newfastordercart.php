<?php
class ControllerExtensionModuleLuxshopNewfastordercart extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && isset($this->request->post['action'])) {
			...
			foreach ($this->cart->getProducts() as $product) {
				...
				$this->load->model('extension/module/luxshop_newfastordercart');
				$results = $this->model_extension_module_luxshop_newfastordercart->addOrder($data);
			...
			$this->response->setOutput($this->load->view('extension/module/luxshop_newfastordercart', $data));
		} else {
