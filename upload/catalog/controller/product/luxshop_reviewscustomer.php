<?php
class ControllerProductLuxshopReviewscustomer extends Controller {
    public function index() {
        ...
        $reviews_total = $this->model_catalog_luxshop_reviewscustomer->getTotalCustomerReviews();

        $results = $this->model_catalog_luxshop_reviewscustomer->getAllCustomerReviews(($page - 1) * $limit, $limit);
        ...
        $pagination->url = $this->url->link('product/luxshop_reviewscustomer', '&page={page}');
		...
		$this->response->setOutput($this->load->view('product/luxshop_reviewscustomer', $data));
    }
}