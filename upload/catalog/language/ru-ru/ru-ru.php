...
$_['button_quote']          = 'Запрос цен';
$_['button_list']           = 'Список';
$_['button_grid']           = 'Сетка';
$_['button_map']            = 'Посмотреть карту';

// Error
$_['error_exception']       = 'Ошибка кода (%s): %s в %s в строке %s';
$_['error_upload_1']        = 'Размер файла превышает значение upload_max_filesize в php.ini';
$_['error_upload_2']        = 'Размер файла превышает значение MAX_FILE_SIZE, указанное в настройках';
$_['error_upload_3']        = 'Файлы были загружены частично';
